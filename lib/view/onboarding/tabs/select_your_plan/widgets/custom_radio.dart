...
import 'package:ontrack/view_model/onboarding/select_your_plan/select_your_plan_provider.dart';
...
class CustomRadio extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final selectedGoal = ref.watch(selectYourPlanProvider);
    return Container(
            ...
            child: RadioTheme(
              ...
              child: Radio(
                ...
                onChanged: (value) {
                  print('value: $value');
                  ref
                      .read(selectYourPlanProvider.notifier)
                      .changeSelectYourPlan(index);
                },
              ),
            ),
          ),
